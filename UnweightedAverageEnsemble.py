...
print(timestr)
# Script version
scriptversion = "MultiTestAvgEnsmblArchname"
print("Script: "+scriptversion)

# Common outputinfo
outputinfo = scriptversion+'_'+timestr+'_b'+str(batch_size)+'_e'+str(epochs)+'archname_avg_ensemble' # Adjust if wanted
...
# Paths to all models generated from 5-fold crossvalidation training that will be used in an average ensemble
...
model5._name='arhcname_model5'

models = [model1, model2, model3, model4, model5]

model_input = layers.Input((cropdim, cropdim, cropdim, 1))
model_outputs = [model(model_input) for model in models]
ensemble_output = keras.layers.Average()(model_outputs) # unweighted average ensemble
...
print("Completed: Average ensemble with <archname>", outputinfo)
